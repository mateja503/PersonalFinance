...
namespace PersonalFinance.Repository.Migrations
{
    ...
    [Migration("20250313113722_AddColumnToAccountUser")]
    partial class AddColumnToAccountUser
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("PersonalFinance.Domain.Identity.Auth", "UserAuthentication", b1 =>
                        {
                            ...
                            b1.Property<string>("au_password_has")
                                .IsRequired()
                                .HasMaxLength(500)
                                .HasColumnType("nvarchar(500)");

                            b1.Property<string>("au_password_salt")
                                .IsRequired()
                                .HasMaxLength(500)
                                .HasColumnType("nvarchar(500)");
